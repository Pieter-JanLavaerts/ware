...
/* package oware-0.1.0.0 */
#ifndef VERSION_oware
#define VERSION_oware "0.1.0.0"
#endif /* VERSION_oware */
#ifndef MIN_VERSION_oware
#define MIN_VERSION_oware(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_oware */
...
#define CURRENT_COMPONENT_ID "oware-0.1.0.0-inplace-oware"
